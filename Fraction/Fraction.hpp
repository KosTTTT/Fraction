...
/**
 * @brief  munus sign is alway at the numerator. Default is zero.
...
public:
        ...
        {}
        /**
         * @brief Convert double to a Fraction. Only 8 digits after dot are converted.
         *          So, one might want to round double up to 8th digit after the dot or
         *          increase presicion inside the constructor maybe.
         */
        Fraction(double v);
